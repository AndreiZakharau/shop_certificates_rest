...
//        int offset = Pagination.offset(page, size);
        ...
        List<TagDto> tags = (service.getAllTag(page, size));
...
//        return CollectionModel.of(tags.stream().peek(tagLink::addTadDtoLink).collect(Collectors.toList()), tagDto.getLinks());
        return CollectionModel.of(tags.stream().collect(Collectors.toList()), tagDto.getLinks());
    }
    ...
    public ReadTag getTag(@PathVariable long id) {
        ReadTag model = service.findById(id);
//        tagLink.addLinks(model);
        return model;
    }
...
//        int offset = Pagination.offset(page, size);
        ...
        List<ReadTag> list = service.getAllEntity(page,size );
//        tagLink.pageLink(page, size,readTag);
        return CollectionModel.of(list.stream().collect(Collectors.toList()), readTag.getLinks());
