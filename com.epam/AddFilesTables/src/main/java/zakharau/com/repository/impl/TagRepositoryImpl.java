...
@Repository
public class TagRepositoryImpl implements Serializable {

    private static final String SQL_INSERT_TAG = "INSERT INTO Tags(tag_name) VALUES (?)";

//    public List<Tag> getAllEntity(int limit, int offset) throws SQLException, ClassNotFoundException {
//        Session session = (Session) DBConnect.getConnection();
//
...
//    }
    ...
    public void addEntity(Tag tag) throws SQLException, ClassNotFoundException {
        try (Connection conn = DBConnect.getConnection();
             PreparedStatement preparedStatement = conn.prepareStatement(SQL_INSERT_TAG)) {
...
//    public Optional<Tag> getEntityById(long id) throws SQLException, ClassNotFoundException {
//        Session session = (Session) DBConnect.getConnection();
//        return session
